 ...
 */
package uk.ac.kcl.inf.model25.projects.services;
...
public class ProjectsLangGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class ProjectElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "uk.ac.kcl.inf.model25.projects.ProjectsLang.Project");
	...
	public class TaskElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "uk.ac.kcl.inf.model25.projects.ProjectsLang.Task");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class PersonElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "uk.ac.kcl.inf.model25.projects.ProjectsLang.Person");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EffortElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "uk.ac.kcl.inf.model25.projects.ProjectsLang.Effort");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("uk.ac.kcl.inf.model25.projects.ProjectsLang".equals(grammar.getName())) {
				return grammar;
			}
